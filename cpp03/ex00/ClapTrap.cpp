...
ClapTrap::ClapTrap()
{
    ...
    energyPoints = 10;
    attackDamage = 0;
    cout << "Default ClapTrap is constructed!" << endl;
}
...
ClapTrap::ClapTrap(string name) : name(name),
                                  ...
                                  attackDamage(0)
{
    cout << "ClapTrap " << name << " is constructed!" << endl;
}
...
{
    cout << "Copy ClapTrap " << name << " is constructed!" << endl;
}

ClapTrap::~ClapTrap()
{
    cout << "ClapTrap " << name << " is destructed!!" << endl;
}
